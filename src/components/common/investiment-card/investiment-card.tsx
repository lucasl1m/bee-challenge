...
import { InvestimentAccount } from '../../../pages/home-page/types';

export interface InvestimentCardProps extends React.HTMLAttributes<HTMLDivElement> {
    data: InvestimentAccount | undefined;
}

export function InvestimentCard({ data }: InvestimentCardProps): JSX.Element {
    return (
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between">
                    <Heading size="2xl" className="text-white w-full truncate">
                        <strong>{data != null ? formatAmout(data.amount) : '---'}</strong>
                    </Heading>
